classdef EKF4 < handle
    ...
    methods
        ...
        function obj = EKF4(ra, rm, rg, rgb, ru, hi, si, ab, as)
            ...
            if ~all(obj.X_pos(5:7))
                obj.X_pos(5:7) = normrnd(0,0.1,3,1);
            end
        end
...
%                 obj.X_att(1), obj.X_att(2), -obj.X_att(3), -obj.X_att(4)];
            ...
            obj.X_pos(5:7) = obj.acc - aG;

            J_wRb = 2 * obj.G_ACC_VAL*...
              [-obj.X_att(3), obj.X_att(4), -obj.X_att(1), obj.X_att(2);
                obj.X_att(2), obj.X_att(1), obj.X_att(4), obj.X_att(3);
                obj.X_att(1), -obj.X_att(2), -obj.X_att(3), obj.X_att(4)];
            obj.P_pos(5:7,5:7) = J_wRb*obj.P_att(1:4,1:4)*J_wRb' + obj.Ra;
        end
